...
public class LazyAdapter  extends BaseAdapter
{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView title = (TextView)vi.findViewById(R.id.book_item_title);
        TextView author = (TextView)vi.findViewById(R.id.book_item_author);
        TextView genre = (TextView)vi.findViewById(R.id.book_item_genre);
        ImageView thumb_image=(ImageView)vi.findViewById(R.id.book_item_cover);
